...
def generate_string_art_route(): # Renamed to avoid conflict with imported function
    ...
    try:
        ...
        # --- End of Autocontrast ---
            ...
            img_array = np.array(img) # Now this array is from the contrast-enhanced image
            
            app.logger.info(f"Image processed for generation: mode={img.mode}, size={img.size}, nail_count={nail_count}, line_count={line_count}")
